...
type DataInterceptor interface {
	BeforeLoad(resourceId string, ds interface{}, field []string, context map[string]interface{}, id string) (bool, error)
	AfterLoad(resourceId string, ds interface{}, field []string, context map[string]interface{}, data map[string]string) error
	...
	BeforeListMap(resourceId string, ds interface{}, field []string, context map[string]interface{}, filter *string, sort *string, group *string, start int64, limit int64, includeTotal bool) (bool, error)
