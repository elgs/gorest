...
type SqliteDataOperator struct {
	*DefaultDataOperator
	Ds string
}

func (this *SqliteDataOperator) Load(tableId string, id string, context map[string]interface{}) (map[string]string, error) {
...
func (this *SqliteDataOperator) ListMap(tableId string, filter []string, sort string,
...
func (this *SqliteDataOperator) ListArray(tableId string, filter []string, sort string,
...
func (this *SqliteDataOperator) Create(tableId string, data map[string]interface{}, context map[string]interface{}) (interface{}, error) {
	tableId = normalizeTableId(tableId, this.Ds)
	context["table_id"] = tableId
	db, err := getConn(this.Ds)
	defer db.Close()
...
func (this *SqliteDataOperator) Update(tableId string, data map[string]interface{}, context map[string]interface{}) (int64, error) {
	tableId = normalizeTableId(tableId, this.Ds)
	context["table_id"] = tableId
	db, err := getConn(this.Ds)
	defer db.Close()
...
func (this *SqliteDataOperator) Duplicate(tableId string, id string, context map[string]interface{}) (interface{}, error) {
	tableId = normalizeTableId(tableId, this.Ds)
	context["table_id"] = tableId
	db, err := getConn(this.Ds)
	defer db.Close()
...
func (this *SqliteDataOperator) Delete(tableId string, id string, context map[string]interface{}) (int64, error) {
	tableId = normalizeTableId(tableId, this.Ds)
	context["table_id"] = tableId
	db, err := getConn(this.Ds)
	defer db.Close()
...
func (this *SqliteDataOperator) QueryMap(tableId string, sqlSelect string, sqlSelectCount string,
	start int64, limit int64, includeTotal bool, context map[string]interface{}) ([]map[string]string, int64, error) {
	ret := make([]map[string]string, 0)
	tableId = normalizeTableId(tableId, this.Ds)
	context["table_id"] = tableId
...
func (this *SqliteDataOperator) QueryArray(tableId string, sqlSelect string, sqlSelectCount string,
	start int64, limit int64, includeTotal bool, context map[string]interface{}) ([][]string, int64, error) {
	ret := make([][]string, 0)
	tableId = normalizeTableId(tableId, this.Ds)
	context["table_id"] = tableId
